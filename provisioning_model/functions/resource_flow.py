...
def get_country_data(df, outcome_df, realm_df, mat_flows_df, country, year):
    ...
    normalized_data = normalize_series(data, world_mean, world_std,
                                       ["agriculture", "industry", "services", "grosscapital", "unemployed", "wealth",
                                        "gini", "voice", "femaleminister", "ecirank", "exports", "resourcerents",
                                        "concentration"])
    ...
    agriculture, industry, services, grosscapital, unemployed, wealth, gini, voice, femaleminister, eci, exports, resourcerents, concentration = normalized_data.values()
